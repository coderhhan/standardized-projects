  ...
  themeConfig: {
    nav: [
      { text: '首页', link: '/index.md' },
      {
        text: '编码规范',
        items: [
          { text: 'HTML 编码规范', link: '/encode/html.md' },
          { text: 'CSS 编码规范', link: '/encode/css.md' },
          { text: 'JavaScript 编码规范', link: '/encode/javascript.md' },
          { text: 'Typescript 编码规范', link: '/encode/typescript.md' },
    ...
    sidebar: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            path: '/encode/javascript.md',
          },
          {
            title: 'Typescript 编码规范',
            path: '/encode/typescript.md',
          },
          // {
          //   title: 'Node 编码规范',
          //   path: '/coding/node.md',
