...
本规则涉及 CSS 与预编译语言 Sass、Less 的编码风格和最佳实践，部分 规则
规则可通过 stylelint（14v.x.x） 工具落地

## 1.CSS

### 1.1 编码风格

![style](./img/css/css.svg)
...
- 1.1.10.【推荐】单行代码最多不要超过 100 个字符。 `stylelint`: max-line-length 除了以下两种情况：
